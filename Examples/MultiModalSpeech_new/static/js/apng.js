! function(e) {
	...
	//u.type = "file", u.accept = "image/png", document.getElementById("choose-btn").addEventListener("click", function() {
	//	return u.click()
	//}), u.addEventListener("change", function() {
	//	u.files.length > 0 && i(u.files[0]), u.value = ""
	//});
    //////*************///////
    ...
    async function createApngPlayer(url) {
        ...
        //const apng = i(imgBuffer);
      }
    ////***************////////
    //const img1Src = 'https://raw.githubusercontent.com/talkr-app/talkr-apng/master/docs/sample.png'
    const img1Src = 'https://i.postimg.cc/cCggr1jm/sample-small.png'
	//const img1Src = 'https://raw.githubusercontent.com/deema-A/temp/main/sample_50smaller.png'
    ...
    document.getElementById("play-pause-btn").addEventListener("click", function(e) {
		...
		console.log('animate 2 now ', now);
		let time_est = parseInt(now);
        time_est = (time_est*0.22*1000).toExponential();
		//time_est = 2e3;
        //speechSynthesis.speak(msg);
		console.log("animate 2 time_est ", time_est);
